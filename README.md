...
`/Applications/Discord RP.app`. Implementation notes and deviations: `.hermes/plans/2026-09-20_004459-native-menubar-app.md`.
Menu/editor design spec (Open Design): `docs/ui/discord-rp-menu-spec.html`.
